...
import 'package:flutter_ume/kits/show_code/src/page_info_helper.dart';
import 'package:flutter_ume/kits/show_code/src/syntax_highlighter.dart';
      ...
      child: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: SelectableText.rich(
            ...
            style: DefaultTextStyle.of(context).style.apply(fontSizeFactor: _textScaleFactor),
          ),
        ),
      ),
    );
              ...
              Expanded(
                child: TextField(
                  ...
                  onSubmitted: (value) {
                    ...
                    pageInfoHelper.getCodeListByKeyword(value).then((codeList) {
