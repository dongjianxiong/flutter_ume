...
import 'package:flutter_ume/kits/dio_log/src/constants/constants.dart';
...
class DioPluggableState extends State<DioInspector> {
  ...
  Widget _clearAllButton(BuildContext context) {
    return GestureDetector(
      onTap: InspectorInstance.httpContainer.clearRequests,
      child: ClipRRect(
...
class _ResponseCardState extends State<_ResponseCard> {
  ...
  void initState() {
    super.initState();
    _isExpanded =  ValueNotifier<bool>(_response.requestOptions.extra[DIO_EXTRA_OPEN_STATE]);
  }
  ...
  void _switchExpand() {
    ...
    _response.requestOptions.extra[DIO_EXTRA_OPEN_STATE] = !_response.requestOptions.extra[DIO_EXTRA_OPEN_STATE];
  }
