...
class _ColorButtonState extends State<ColorButton> with WidgetsBindingObserver {
  ...
  OverlayEntry _buildPickerOverlay(Offset offset, BuildContext context) {
    ...
    final pickerPosition = onLandscape ? offset : calculatePickerPosition(offset, mq.size);
  ...
  void didChangeMetrics() {
    final keyboardTopPixels = PlatformDispatcher.instance.implicitView!.physicalSize.height -
        PlatformDispatcher.instance.implicitView!.viewInsets.bottom;

    final newBottom =
        (PlatformDispatcher.instance.implicitView!.physicalSize.height - keyboardTopPixels) /
