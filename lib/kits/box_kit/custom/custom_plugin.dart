...
final customIconBytes = base64Decode(customIconData);

class CustomPlugin implements Pluggable {
  final List<String> eventNames;
  final Function(String event) onFinish;
  CustomPlugin({required this.eventNames, required this.onFinish});
  @override
