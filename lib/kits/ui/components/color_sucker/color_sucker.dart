...
class _ColorSuckerState extends State<ColorSucker> {
  ...
  void initState() {
    ...
    _windowSize = PlatformDispatcher.instance.implicitView!.physicalSize /
    ...
    return Stack(
      ...
      children: [
        Positioned(
            left: 0,
            top: _toolBarY,
            child: GestureDetector(onVerticalDragUpdate: _toolBarPanUpdate, child: toolBar)),
        Positioned(
            ...
            child: GestureDetector(
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      borderRadius: _radius!, border: Border.all(color: Colors.grey, width: 3)),
                ),
              ),
            ),
          ),
