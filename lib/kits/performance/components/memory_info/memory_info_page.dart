                    ...
                    return GestureDetector(
                      ...
                      onTap: () {
                        _DetailModel detail = _DetailModel(
                            stats.instancesAccumulated, stats.classRef!.id, stats.classRef!.name);
...
class _PerRow extends StatelessWidget {
  const _PerRow({Key? key, this.widgets, this.customColor, this.darkColor = false})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      color: this.customColor ??
          (this.darkColor ? Colors.grey.withOpacity(0.2) : Colors.grey.withOpacity(0.03)),
      child: Row(
          children: this
              .widgets!
              .map((e) => Expanded(
