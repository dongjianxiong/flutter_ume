...
```
cd existing_repo
git remote add origin http://gitlab.hzcxfw.com/terminal/structure/flutter_ume.git
git branch -M main
...
- [ ] [Set up project integrations](http://gitlab.hzcxfw.com/terminal/structure/flutter_ume/-/settings/integrations)
